...
The description of the vaccination effects on an outbreak is quite lengthy. Considering the collection at  \href{https://terna.to.it/simul/GAresultPresentation.pdf}{https://terna.to.it/simul/GAresultPresentation.pdf}, we concentrate on a unique case.
...
In Fig. \ref{seqPlain} we have the effects of the vaccination plan as number of vaccinated persons by groups. In Fig. \ref{timeSeriesPlain} we have the most important observation: 
