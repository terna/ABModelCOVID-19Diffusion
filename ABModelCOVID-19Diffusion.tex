...
Use the 3D representation of the model world.

\begin{figure}[t]
\center
\fbox{\includegraphics[width=0.9\textwidth,,angle=0]{3D.png}}
\caption{3D representation of the model world}
\label{3D}
\end{figure}

A gallery of contagion sequences in Table \ref{table_of_figures}.
...
1 & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} \\
2 & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} \\
3 & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} \\
4 & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} \\
5 & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} & \includegraphics[width=12em]{prova/no3a.png} \\
            \hline\noalign{\smallskip}
        \end{tabular}
        \caption{Table of figures}
        \label{table_of_figures}
    \end{table}
