...
\begin{figure}[t]
     ...
     \begin{subfigure}{0.48\textwidth}
         \centering
         \fbox{\includegraphics[width=1\textwidth]{andamento900annotato.jpg}}
         \caption{Key points in epidemic dynamic in Summer and Fall 2020 in Piedmont}
         \label{actualA}
     \end{subfigure}
     \hfill
     \begin{subfigure}{0.48\textwidth}
         \centering
         \fbox{\includegraphics[width=1\textwidth]{andamento900.jpg}}
         \caption{Data in Piedmont until July 2021, reporting three waves}
         \label{actualB}
     \end{subfigure}
     \caption{Actual data}
     \label{actualData}
