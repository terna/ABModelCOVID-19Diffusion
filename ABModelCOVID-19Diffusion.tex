...
\begin{figure}[t]
 ...
 %  /Users/pt/GitHub/readSIsaR_BatchResults 
 %  readRunResults10kStableSeedsCPoints_noControl_ChangingWorld_plusHMlogBIG.ipynb
 ...
 %  /Users/pt/GitHub/readSIsaR_BatchResults 
 %  readRunResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptChangingWorld_plusHMlogBIG.ipynb
...
% /Users/pt/GitHub/analisiDatiProtezioneCivile/infoSIsaR_BIG.ipynb
\begin{figure}[t]
...
%  all in /Users/pt/GitHub/readSIsaR_BatchResults 
\begin{figure}[t]
 \begin{subfigure}{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.95\textwidth]{10kSpontWave2.png}} % selectResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptChangingWorld_plusHMlogBIG.ipynb
 ...
 \begin{subfigure}{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.95\textwidth]{10kForceWave2.png}} % selectResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptChangingWorldNewStart_plusHMlogNIG.ipynb
 \subcaption{First wave with non-pharmaceutical containment measures, forcing the second wave, without specific measures}
 \label{secondFromOut}
 \end{subfigure}
 \begin{subfigure}{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.95\textwidth]{10kForceWave2Contr2.png}} % selectResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptOctMarControlChangingWorldNewStart_plusHMlogBIG.ipynb
 ...
 \begin{subfigure}{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.95\textwidth]{10kForceWave2Contr2M-20.png}} % selectResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptOctMar-20ControlChangingWorldNewStart_plusHMlogBIG.ipynb
 ...
 \begin{subfigure}{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.95\textwidth]{10kForceWave2NoFragOct5for60d.png}} % selectResults10kStableSeedsCPoints_basicControlB_schoolOpenSeptNoFragOCT05-60dControlChangingWorldNewStart_plusHMlogBig.ipynb
...
\begin{figure}[t]
 ...
 \centering
% in /Users/pt/GitHub/GAs
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_plainVaccinationSequence.png}} % experiment_I_vaccination_plotsBIG.ipynb
 ...
 \centering
 % in /Users/pt/GitHub/contagionSequence
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_1_plain_symptomatic_series.png}} % using contagionSeriesByGroupsBIG.ipynb on Experiment_I_plain_1.csv 
...
\begin{subfigure}{0.4\textwidth}
 \centering
 % in /Users/pt/GitHub/GAs
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_wiseVaccinationSequence.png}} % experiment_I_vaccination_plotsBIG.ipynb
 ...
 \centering
 % in /Users/pt/GitHub/contagionSequence
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_1_wise_symptomatic_series.png}} % using contagionSeriesByGroupsBIG.ipynb on Experiment_I_wise_1.csv
...
\begin{subfigure}{0.4\textwidth}
 \centering
 % in /Users/pt/GitHub/GAs
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_GA_1_VaccinationSequence.png}}  % experiment_I_vaccination_plotsBIG.ipynb
 ...
 \centering
 % in /Users/pt/GitHub/contagionSequence
 \fbox{\includegraphics[width=0.95\textwidth]{Experiment_I_1_GAs_symptomatic_series.png}} % using contagionSeriesByGroupsBIG.ipynb on Experiment_I_1bestGA.csv 
...
% sequentialRecordsBIG.ipynb in /Users/pt/GitHub/contagionSequence
 \begin{table}[t]
 \centering
 \begin{tabular}{cccc}
 \hline\noalign{\smallskip}
...
5 & \includegraphics[width=12em]{sequences/withShort0.png} & %using SIsaR 9.4.2 as is (basic control) with 123456_22313, file ex123456_22313.csv
 ...
 \includegraphics[width=12em]{sequences/withShort1A.png} %using SIsaR 9.4.2 as is (basic control + 20 sFW 1,i.e., stop Fragile Workers) with 123456_22314A
\\
6 & \includegraphics[width=12em]{sequences/withShort1A200.png} & %using SIsaR 9.4.2 as is (basic control + 20 sFW 1,i.e., stop Fragile Workers) with 123456_22314A with 200
 \includegraphics[width=12em]{sequences/withShort1B.png} & %using SIsaR 9.4.2 as is (basic control + $$$) with 123456_22314B
 \includegraphics[width=12em]{sequences/withShort2.png} %using SIsaR 9.4.2 as is (basic control) with 123456_22315, file ex123456_22315.csv123456_22315
\\
 \hline\noalign{\smallskip}
 \end{tabular}
