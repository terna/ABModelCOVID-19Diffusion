...
Finally, the objective of this whole section: the use of GAs, evolving populations of models repeating this same experiment, but choosing the parameters to decide daily vaccination on a random basis initially and successively considering them as a genetic chromosome of the model re-productively crossed with those of other models searching for the best fitness related to the goal of reducing the number of symptomatic persons. \cite{miller1998active}, also quoted at \href{https://www.behaviorsearch.org}{https://www.behaviorsearch.org}, is a useful introduction to the methodology; the sources of the GAs used here are at \href{https://github.com/terna/GAs}{https://github.com/terna/GAs}.
