...
We display multiple information using three elements.
  \begin{itemize}
   \item Colors: black for unknown places, gray for open spaces, cyan for houses, orange for nursing homes, pink for hospitals, yellow for schools, brown for factories, with shops and offices.
...
Fig. \ref{shortExample} is useful as an example. VEDERE WORD
