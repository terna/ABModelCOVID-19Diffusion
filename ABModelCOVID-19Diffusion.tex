...
Doing the batches of 10,000 repetitions of the simulation, we use random maps to have a neutral effect of the structure of the space. 
...
\subsection{Some notes on vaccines (Alberto's section)}
\label{vaccineAction}
